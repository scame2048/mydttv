...
typedef int (*ao_get_parameter)(struct ao_context *aoc, int cmd, unsigned long arg);
typedef int (*ao_set_parameter)(struct ao_context *aoc, int cmd, unsigned long arg);
