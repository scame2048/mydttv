package dai.android.learn.dttv;
...
import dai.android.learn.dttv.utils.FileUtils;
import dai.android.learn.dttv.utils.Logger;
...
public class MediaPlayer {
    ...
    public MediaPlayer(Context ctx, boolean preferHWDecoder) {
        ...
        Logger.d(TAG, "Native Setup.ret:" + ret + " use hw:" + (preferHWDecoder ? 1 : 0));
        if (ret >= 0) {
    ...
    public int setAuxEffectSendLevel(int type) {
        Logger.d(TAG, "setaudio effect:" + type);
    ...
    private SparseArray<MediaFormat> parseTrackInfo(byte[] tracks, String encoding) {
        ...
        try {
            ...
            Logger.e(TAG, "getTrackMap exception");
        ...
        for (String s : trackString.split("!#!")) {
            try {
                ...
                Logger.e(TAG, "parseTrackInfo:" + trackNum + mediaFormat.toString());
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MEDIA_FRESH_VIDEO:
                    ...
                    break;
                case MEDIA_ERROR:
                    Logger.e(TAG, "Error occured. Error ID = " + msg.what);
